...
from dialogs.greetings import Greetings
from dialogs.goodbye import Goodbye
...
from classes.classes import rra, mmhm, face_name, greetings, goodbye, language
...
class MainDialog(ComponentDialog):
    ...
    def __init__(
        self, raise_your_hand_dialog: Raise_Your_Hand, mimic_my_hand_movement: Mimic_My_Hand_Movement,
          ask_your_name: Ask_Your_Name, greeting: Greetings, goodbyes: Goodbye, user_state
    ):
        """
        ...
        self._greeting_id = greeting.id
        self._goodbyes_id = goodbyes.id
        ...
        self.add_dialog(greeting)
        self.add_dialog(goodbyes)
            ...
            for a in output.answers:
                ...
                # Go to LUIS since the confidence level in QnA is below 0.8
                    ...
                    if confidence > 0.8:
                        ...
                        elif top_intent == "greetings": 
                            # fill in the class mmhm attributes with the extracted intent
                            greetings.intent = top_intent
                            return await step_context.begin_dialog(Greetings.__name__)      
                        elif top_intent == "goodbye": 
                            # fill in the class mmhm attributes with the extracted intent
                            goodbye.intent = top_intent
                            return await step_context.begin_dialog(Goodbye.__name__)                   
